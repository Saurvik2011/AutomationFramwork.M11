...
public class Scenario3 {
	...
	public static void main(String[] args) throws Throwable {
		...
		Thread.sleep(3000);
		driver.findElement(By.cssSelector(".allMnuTable > tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(5) > table:nth-child(1) > tbody:nth-child(1) > tr:nth-child(6) > td:nth-child(1) > a:nth-child(1)")).click();
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		driver.findElement(By.name("vendorname")).sendKeys("abc");
		Thread.sleep(3000);
